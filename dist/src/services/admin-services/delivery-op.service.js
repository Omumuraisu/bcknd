...
export const createDeliveryOperator = async (input) => {
...
export const getDeliveryOperatorById = async (id) => {
    return prisma.account.findUnique({
        where: { account_id: BigInt(id) },
        include: { hubStaff: true },
    });
};
export const updateDeliveryOperator = async (id, data) => {
...
export const deleteDeliveryOperator = async (id) => {
...
export const getDeliveryOperatorSelfProfile = async (accountId) => {
...
export const updateDeliveryOperatorSelfProfile = async (accountId, input) => {
...
export const requestDeliveryOpActivationOtp = async (contactNumber) => {
...
export const activateDeliveryOperator = async (input) => {
