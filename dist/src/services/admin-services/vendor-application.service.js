...
import { AccountStatus, VendorApplicationStatus, } from '../../generated/prisma/client';
...
export const listPendingVendorApplicationsByBusiness = async (businessId) => {
...
export const requestVendorApplicationCompliance = async (applicationId, requiredDocuments, complianceNote) => {
...
export const approveVendorApplication = async (applicationId) => {
    const applicationKey = BigInt(applicationId);
