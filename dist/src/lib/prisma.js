...
if (!sslmode) {
    ...
    if (defaultSslMode === "no-verify") {
        ...
        console.warn("No sslmode in DATABASE_URL. Defaulting to sslmode=no-verify for local development. " +
...
if (allowInsecureSsl) {
    ...
    // eslint-disable-next-line no-console
    console.warn("ALLOW_INSECURE_DB_SSL=true: TLS certificate verification is disabled for DB connection");
}
