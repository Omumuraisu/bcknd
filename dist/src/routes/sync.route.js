...
import { completeUnloadingFromSync, getSyncDashboard, getTicketsSnapshot, getUnloadingSnapshot, startUnloadingFromSync, upsertTicketFromSync, } from '../services/sync.service.js';
...
const ensureSyncRole = async (c, next) => {
