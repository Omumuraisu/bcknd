...
import { createVendor, getVendorsByBusiness, deleteVendor, } from '../services/admin-services/vendor.service.js';
...
vendorRoutes.post('/', async (c) => {
    try {
        ...
        if (!firstName || !lastName || !contact_number || !accountId || !businessId) {
            return c.json({
                error: 'firstName, lastName, contact_number, accountId, and businessId are required',
            }, 400);
        }
