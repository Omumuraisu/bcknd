...
import {
  activateDeliveryOperator,
  createDeliveryOperator,
  deleteDeliveryOperator,
  getDeliveryOperatorSelfProfile,
  getDeliveryOperatorById,
  getDeliveryOperators,
  requestDeliveryOpActivationOtp,
  updateDeliveryOperatorSelfProfile,
  updateDeliveryOperator,
} from '../services/admin-services/delivery-op.service.js';
...
const requireDeliveryOperatorAuth = async (
